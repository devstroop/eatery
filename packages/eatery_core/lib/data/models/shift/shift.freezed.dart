...
mixin _$Shift {
 ...
 int? get id; String get name; String get startTime; String get endTime; bool get isActive;
...
@override
String toString() {
  return 'Shift(id: $id, name: $name, startTime: $startTime, endTime: $endTime, isActive: $isActive)';
}
...
@useResult
$Res call({
 int? id, String name, String startTime, String endTime, bool isActive
});
...
/// Create a copy of Shift
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? startTime = null,Object? endTime = null,Object? isActive = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String name,  String startTime,  String endTime,  bool isActive)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Shift() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String name,  String startTime,  String endTime,  bool isActive)  $default,) {final _that = this;
switch (_that) {
case _Shift():
return $default(_that.id,_that.name,_that.startTime,_that.endTime,_that.isActive);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String name,  String startTime,  String endTime,  bool isActive)?  $default,) {final _that = this;
switch (_that) {
case _Shift() when $default != null:
return $default(_that.id,_that.name,_that.startTime,_that.endTime,_that.isActive);case _:
  return null;
...
class _Shift implements Shift {
  const _Shift({this.id, required this.name, required this.startTime, required this.endTime, this.isActive = true});
...
/// Create a copy of Shift
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? startTime = null,Object? endTime = null,Object? isActive = null,}) {
  return _then(_Shift(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int?,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,startTime: null == startTime ? _self.startTime : startTime // ignore: cast_nullable_to_non_nullable
