...
mixin _$DiningTable {
 ...
 int? get id; String get name; String? get description; int? get orderId; int? get categoryId; int get capacity; DiningTableStatus get status; String? get customerPhone;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,orderId,categoryId,capacity,status,customerPhone);

@override
String toString() {
  return 'DiningTable(id: $id, name: $name, description: $description, orderId: $orderId, categoryId: $categoryId, capacity: $capacity, status: $status, customerPhone: $customerPhone)';
}
...
@useResult
$Res call({
 int? id, String name, String? description, int? orderId, int? categoryId, int capacity, DiningTableStatus status, String? customerPhone
});
...
/// Create a copy of DiningTable
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? description = freezed,Object? orderId = freezed,Object? categoryId = freezed,Object? capacity = null,Object? status = null,Object? customerPhone = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String name,  String? description,  int? orderId,  int? categoryId,  int capacity,  DiningTableStatus status,  String? customerPhone)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiningTable() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.orderId,_that.categoryId,_that.capacity,_that.status,_that.customerPhone);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String name,  String? description,  int? orderId,  int? categoryId,  int capacity,  DiningTableStatus status,  String? customerPhone)  $default,) {final _that = this;
switch (_that) {
case _DiningTable():
return $default(_that.id,_that.name,_that.description,_that.orderId,_that.categoryId,_that.capacity,_that.status,_that.customerPhone);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String name,  String? description,  int? orderId,  int? categoryId,  int capacity,  DiningTableStatus status,  String? customerPhone)?  $default,) {final _that = this;
switch (_that) {
case _DiningTable() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.orderId,_that.categoryId,_that.capacity,_that.status,_that.customerPhone);case _:
  return null;
...
class _DiningTable implements DiningTable {
  const _DiningTable({this.id, required this.name, this.description, this.orderId, this.categoryId, this.capacity = 0, this.status = DiningTableStatus.available, this.customerPhone});
...
/// Create a copy of DiningTable
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? description = freezed,Object? orderId = freezed,Object? categoryId = freezed,Object? capacity = null,Object? status = null,Object? customerPhone = freezed,}) {
