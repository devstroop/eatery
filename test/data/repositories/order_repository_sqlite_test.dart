...
/// End-to-end test of the SQLite-backed [SqliteOrderRepository], exercising the
/// foreign-key relationship (order -> order_product), ON DELETE CASCADE,
/// transactions, and the fix for provisional-id collisions on new entities.
void main() {
  ...
  test('saveOrder inserts, assigns id, round-trips fields', () async {
    final o = makeOrder(phone: '555-1', type: OrderType.delivery, grand: 42.5);
