    ...
    return company != null ? Scaffold(
        ...
        child: ListView(
          ...
          children: [
            ...
            CustomTextFromField(
                ...
                validator: (value) {
                  if (value!.trim().isEmpty) return 'Company name cannot be blank';
                  return null;
                }),
            SpacingStyle.defaultVerticalSpacing,
            CustomTextFromField(
                ...
                validator: (value) {
                  ...
                  if (!value.trim().isValidEmail()) return 'Email address is not valid';
                  return null;
                }),
            SpacingStyle.defaultVerticalSpacing,
            CustomTextFromField(
                ...
                validator: (value) {
                  if (value!.trim().isEmpty) return 'Phone number cannot be blank';
                  if (!value.trim().isValidPhone()) return 'Phone number is not valid';
                  return null;
                }),
            SpacingStyle.defaultVerticalSpacing,
            CustomTextFromField(
            ...
            CustomTextFromField(
              ...
              title: '${Edition.values.singleWhere((element) => element.id == company!.edition).name} License No',
              hint: 'Enter ${Edition.values.singleWhere((element) => element.id == company!.edition).name} license number...',
              focusNode: focus5,
              textInputAction: TextInputAction.next,
              onFieldSubmitted: (v) {
              ...
              validator: (value) {
                if (value!.trim().isNotEmpty && !value.trim().isValidGSTIN()) return '${Edition.values.singleWhere((element) => element.id == company!.edition).name} license number is not valid';
                return null;
              },
            ),
            SpacingStyle.defaultVerticalSpacing,
            CustomTextFromField(
              ...
              title: '${Edition.values.singleWhere((element) => element.id == company!.edition) == Edition.gst ? 'FSSAI' : 'Food'} License No',
              hint: 'Enter ${Edition.values.singleWhere((element) => element.id == company!.edition) == Edition.gst ? 'FSSAI' : 'Food'} license number...',
              focusNode: focus6,
              textInputAction: TextInputAction.next,
              onFieldSubmitted: (v) {
              ...
              validator: (value) {
                if (value!.trim().isNotEmpty && (value.trim().length < 10 || !value.trim().isNumericOnly)) return '${Edition.values.singleWhere((element) => element.id == company!.edition) == Edition.gst ? 'FSSAI' : 'Food'} license number is not valid';
            ...
            CustomTextFromField(
              ...
              title: 'Default ${Edition.values.singleWhere((element) => element.id == company!.edition).name} Rate',
              hint: 'Enter default ${Edition.values.singleWhere((element) => element.id == company!.edition).name} rate...',
              suffixWidget: Icon(Icons.percent, color: ColorStyle.text400,),
              focusNode: focus7,
              textInputAction: TextInputAction.done,
              validator: (value) {
                if (value!.trim().isNotEmpty && !value.trim().isNum) return 'Default ${Edition.values.singleWhere((element) => element.id == company!.edition).name} license number is not valid';
                // if (edition == Edition.gst && !value!.trim().isValidGSTIN()) return '${edition.name} license number is not valid';
                return null;
              },
              onFieldSubmitted: (v) {
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              PrimaryButton(color: themeColor, child: const Text('Save'),
                onPressed: () async {
