...
class ForgotPasswordBottomSheet extends StatefulWidget {
  ...
  const ForgotPasswordBottomSheet(this.context, {Key? key, required this.themeColor, required this.callback}) : super(key: key);
          ...
          child: ListView(
            ...
            children: [
              ...
              if(!verified)
                ...
                onChanged: (value){
                  var temp = EateryDB().subscriptionBox().values.singleWhere((element) => element.id == company!.subscriptionId!);
              ...
              if(verified)
                CustomTextFromField(
                  ...
                  validator: (value) {
                    if(!value!.trim().isNumericOnly) return 'Invalid character';
                    if (value.trim().isEmpty || _controllerPassword.text != value ) return "Confirm pin didn't match";
                    return null;
                  },
                  onFieldSubmitted: (v) {
                    FocusScope.of(context).unfocus();
              ...
              if(verified)
                Row(
                  children: [
                    PrimaryButton(color: widget.themeColor, child: const Text('Reset'), onPressed: _submit,),
                  ],
                ),
