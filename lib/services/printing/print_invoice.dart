...
class PrintInvoice {
  ...
  static Future<List<int>> generateReceipt(
    ...
    bytes += ticket.text('${account['address']}',
        styles: const PosStyles(align: PosAlign.center));
    bytes += ticket.text('${account['phone']}, ${account['email']}',
        styles: const PosStyles(align: PosAlign.center));
    ...
    bytes += ticket.row([
      ...
      PosColumn(
          ...
          width: 5,
          styles: const PosStyles(
              align: PosAlign.right, width: PosTextSize.size1, bold: true)),
    ]);
    bytes += ticket.row([
      PosColumn(
    ...
    bytes +=
        ticket.text(timestamp, styles: const PosStyles(align: PosAlign.center));
    ...
    if (order['tableName'] != null) {
      bytes += ticket.row([
        PosColumn(
            ...
            width: 4,
            styles: const PosStyles(
                align: PosAlign.left, width: PosTextSize.size2)),
        PosColumn(
            text: '${order['tableName']}',
            width: 8,
            styles: const PosStyles(
                align: PosAlign.right, width: PosTextSize.size2, bold: true)),
      ]);
      bytes += ticket.hr(ch: '-', linesAfter: 1);
    }
