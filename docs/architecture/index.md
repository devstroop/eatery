...
| 03 | [Database Schema](database-schema.md) | Hive legacy vs SQLite, migration flags, schema versioning |
...
| 12 | [Routing](routing.md) | GoRouter setup, route table, auth redirect, migration status |
