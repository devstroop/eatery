...
> **Schema foundation:** [schema-audit.md](schema-audit.md)
...
|  -  Your admin account                              |
|  -  Restaurant created                              |
|  o  Add your first menu item   -> Products           |
|  o  Set up dining tables       -> Tables             |
|  o  Add your team              -> Staff              |
|  o  Set your restaurant name   -> Settings           |
|  o  Configure tax (optional)   -> Tax                |
|  o  Set up a printer (optional)-> Printers           |
|                                                      |
